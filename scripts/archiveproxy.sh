...
if command -v wget > /dev/null; then
    wget -O $install_dir/1panel/resource/apps/local/napcat-1panel-napcat.zip https://ghp.ci/https://github.com/Fahaxikiii/napcat-1panel/archive/refs/heads/napcat.zip
else
    curl -o $install_dir/1panel/resource/apps/local/napcat-1panel-napcat.zip https://ghp.ci/https://github.com/Fahaxikiii/napcat-1panel/archive/refs/heads/napcat.zip
fi
